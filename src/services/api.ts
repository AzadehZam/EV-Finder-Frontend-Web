...
const PRODUCTION_API_URL = 'https://ev-finder-backend.onrender.com/api';
const API_BASE_URL = import.meta.env.VITE_API_URL || (import.meta.env.PROD ? PRODUCTION_API_URL : 'http://localhost:3000/api');
